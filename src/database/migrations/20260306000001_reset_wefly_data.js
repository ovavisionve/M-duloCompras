/**
 * Migration: Reset demo data and configure WEFLY2022 C.A.
 * This replaces all demo/sample data with real client configuration.
 */
...
exports.down = async function (knex) {
  // No rollback - this is a data reset
};
